...
async def diagnostics() -> dict[str, Any]:
    ...
    return {
        ...
        "llm_configured": llm_extractor_configured(),
        "openai_configured": resolve_openai_api_key() is not None,
        "azure_openai_configured": (azure_cfg := resolve_azure_openai_config()) is not None,
        "azure_extractor_deployment": azure_cfg.deployment if azure_cfg else None,
